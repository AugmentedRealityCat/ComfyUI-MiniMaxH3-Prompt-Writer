  ...
  function paint(layer, markup) {
    ...
    for (const node of template.content.childNodes) {
      ...
      if (node.nodeType === 1 && end > offset) {
        const name = "h3ps-sequence-" + node.className.slice(3);
