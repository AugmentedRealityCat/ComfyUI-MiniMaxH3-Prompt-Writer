...
Standalone for Windows: **0.1.6** · [Download ZIP](../../releases/download/standalone-v0.1.6/H3-Prompt-Writer-Standalone-Windows-v0.1.6.zip) · [Setup guide](standalone/README.md)
